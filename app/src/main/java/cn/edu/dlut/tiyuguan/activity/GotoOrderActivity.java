...
import cn.edu.dlut.tiyuguan.global.VenusBasicInfo;
...
public class GotoOrderActivity extends Activity{
	...
	//从Intent中接受到用户选择了哪一个馆，动态加载界面
		public View chooseView(int index)
		{
			...
			btn2.setTag(2);
			//获取日期信息
			HashMap<String, String> date=VenusBasicInfo.getOrderDate();
			...
			case 1:{
				     ...
				     detailInfo=VenusBasicInfo.getBasketBallVenusInfo();
				     venusname="篮球馆";
			       }break;
			...
			case 2: {
				      ...
				      detailInfo=VenusBasicInfo.getSwimingVenusInfo();
				      venusname="游泳馆";
			        }
			break;
			...
			case 3:
			{
				...
				detailInfo=VenusBasicInfo.getTaiQiuVenusInfo();
				venusname="台球馆";
			}break;
	        //羽毛球馆
			case 4:
			{
				...
				detailInfo=VenusBasicInfo.getBadmintonVenusInfo();
				venusname="羽毛球馆";
			}
				break;
			//乒乓球馆
			case 5: 
				{
					...
					detailInfo=VenusBasicInfo.getTableTennisVenusInfo();
					venusname="乒乓球馆 ";
				}break;
	...
	public void doClick(View v)
	{
		...
		if(tag==0) date=VenusBasicInfo.getOrderDate().get("Today");
	    if(tag==1) date=VenusBasicInfo.getOrderDate().get("Tomorrow");
	    if(tag==2) date=VenusBasicInfo.getOrderDate().get("TheDayAfterTomorrow");
